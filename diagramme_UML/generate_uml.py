...
# Add the User class
uml_full.node("User", '''User''', shape="record")

# Add the Theme class
uml_full.node("Theme", '''Theme''', shape="record")

# Add the Cursus class
uml_full.node("Cursus", '''Cursus''', shape="record")

# Add the Lesson class
uml_full.node("Lesson", '''Lesson''', shape="record")

# Add the Purchase class
uml_full.node("Purchase", '''Purchase''', shape="record")

# Add the Certification class
uml_full.node("Certification", '''Certification''', shape="record")
...
uml_full_filepath = "/Users/emma1/Desktop/CEF/PLATEFORME E-LEARNING « KNOWLEDGE LEARNING »/knowledge-learning/diagramme_UML/knowledge-learning_UML_simple"
